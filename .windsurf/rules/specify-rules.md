...
- 004-transition-history: Added Java 21 + Spring Boot 4.0.3, MongoDB, OpenAPI 3.0.3, Lombok
- 002-mongodb-persistence: Added Java 21 (from constitution) + Spring Boot 4.0.3, Spring Data MongoDB, MongoDB Java Driver
