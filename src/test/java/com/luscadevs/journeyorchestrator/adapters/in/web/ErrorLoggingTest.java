...
/**
 * Unit tests for error logging functionality in GlobalExceptionHandler.
 * Verifies that structured logging includes correlation IDs, context, and proper log levels.
 */
class ErrorLoggingTest {
    ...
    void shouldLogDomainExceptionWithCorrelationId() {
        // Given
        JourneyDefinitionNotFoundException exception = new JourneyDefinitionNotFoundException("test-123");
    ...
    void shouldUseExistingCorrelationIdFromHeader() {
        ...
        JourneyDefinitionNotFoundException exception = new JourneyDefinitionNotFoundException("test-456");
    ...
    void shouldSetCorrectLoggingContextForDomainExceptions() {
        // Given
        InvalidStateTransitionException exception = new InvalidStateTransitionException("instance-123", "RUNNING", "COMPLETED");
    ...
    void shouldGenerateNewCorrelationIdWhenNotProvided() {
        // Given
        when(mockRequest.getHeader("X-Correlation-ID")).thenReturn(null);
        JourneyDefinitionNotFoundException exception = new JourneyDefinitionNotFoundException("test-789");
    ...
    void shouldHandleEmptyCorrelationIdHeader() {
        ...
        JourneyDefinitionNotFoundException exception = new JourneyDefinitionNotFoundException("test-999");
    ...
    void shouldMaintainMdcCleanupAfterException() {
        // Given
        JourneyDefinitionNotFoundException exception = new JourneyDefinitionNotFoundException("test-cleanup");
    ...
    private MethodArgumentNotValidException createMockValidationException() {
        ...
        FieldError fieldError = new FieldError("object", "fieldName", "rejectedValue", false, null, null, "validation message");
