...
class ConditionEvaluatorPropertyTest {
        ...
        void shouldSatisfyCommutativePropertyForAnd() {
                IntStream.range(0, 100).forEach(i -> {
                        ...
                        ContextData context = ContextData.builder().journeyInstanceId("test-" + i)
                                        .currentState("PROCESSING").eventData(eventData)
                                        .journeyData(journeyData).systemData(systemData).build();

                        // Test commutative property: A AND B == B AND A
                        String expression1 =
                                        "#eventData.amount > 1000 AND #journeyData.riskScore > 50";
                        String expression2 =
                                        "#journeyData.riskScore > 50 AND #eventData.amount > 1000";

                        ConditionEvaluationResult result1 =
                                        conditionEvaluator.evaluate(expression1, context);
                        ConditionEvaluationResult result2 =
                                        conditionEvaluator.evaluate(expression2, context);
        ...
        void shouldSatisfyCommutativePropertyForOr() {
                IntStream.range(0, 100).forEach(i -> {
                        ...
                        String expression1 =
                                        "#eventData.amount > 1000 OR #journeyData.riskScore > 50";
                        String expression2 =
                                        "#journeyData.riskScore > 50 OR #eventData.amount > 1000";
        ...
        void shouldSatisfyDeMorgansLaws() {
                IntStream.range(0, 50).forEach(i -> {
                        ...
                        String expression1 =
                                        "NOT (#eventData.amount > 1000 AND #journeyData.riskScore > 50)";
                        String expression2 =
                        ...
                        String expression3 =
                                        "NOT (#eventData.amount > 1000 OR #journeyData.riskScore > 50)";
                        String expression4 =
                                        "(NOT (#eventData.amount > 1000)) AND (NOT (#journeyData.riskScore > 50))";

                        ConditionEvaluationResult result3 =
                                        conditionEvaluator.evaluate(expression3, context);
                        ConditionEvaluationResult result4 =
                                        conditionEvaluator.evaluate(expression4, context);
        ...
        void shouldSatisfyDoubleNegationProperty() {
                IntStream.range(0, 100).forEach(i -> {
                        ...
                        ConditionEvaluationResult doubleNegationResult = conditionEvaluator
                                        .evaluate(doubleNegationExpression, context);
                        ...
                        assertEquals(baseResult.getResult(), doubleNegationResult.getResult(),
                                        "Double negation should equal original expression for iteration "
                                                        + i);
                });
        }
        ...
        void shouldSatisfyIdentityProperties() {
                IntStream.range(0, 50).forEach(i -> {
                        ...
                        assertEquals(baseResult.getResult(), andTrueResult.getResult(),
                                        "AND with true should equal original expression for iteration "
                                                        + i);
                        ...
                        assertEquals(baseResult.getResult(), orFalseResult.getResult(),
                                        "OR with false should equal original expression for iteration "
                                                        + i);
                });
        }
        ...
        void shouldMaintainPerformanceUnderComplexity() {
                ...
                IntStream.range(0, 20).forEach(i -> {
                        ...
                        assertTrue((endTime - startTime) < 50, // Should complete within 50ms
                                        "Complex expression evaluation should complete within 50ms for iteration "
