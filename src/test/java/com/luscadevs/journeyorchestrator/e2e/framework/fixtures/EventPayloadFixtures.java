...
/**
 * Factory class for creating event payload test fixtures.
 * Provides reusable event payloads for E2E testing scenarios.
 */
public class EventPayloadFixtures {
    ...
    public static Map<String, Object> processEvent(double amount) {
        return Map.of(
            ...
            "payload", Map.of(
                "amount", amount,
                "currency", "USD",
                "customerType", amount > 1000 ? "premium" : "standard",
                "timestamp", java.time.Instant.now().toString()
            )
        );
    }
    ...
    public static Map<String, Object> approvalEvent(String approvedBy, double amount) {
        return Map.of(
            ...
            "payload", Map.of(
                ...
                "approvalReason", "Approval by " + approvedBy,
                "timestamp", java.time.Instant.now().toString()
            )
        );
    }
    ...
    public static Map<String, Object> timeoutEvent() {
        return Map.of(
            "event", "TIMEOUT",
            "payload", Map.of(
                "timeoutReason", "Journey exceeded maximum duration",
    ...
    public static Map<String, Object> finalizeEvent() {
        return Map.of(
            ...
            "payload", Map.of(
                "finalized", true,
                "finalizationTimestamp", java.time.Instant.now().toString(),
    ...
    public static Map<String, Object> multiStepEvent(int step) {
        return Map.of(
            "event", step == 1 ? "PROCESS" : step == 2 ? "VALIDATE" : "FINALIZE",
            "payload", Map.of(
                "step", step,
                "stepName", "step-" + step,
                "timestamp", java.time.Instant.now().toString(),
                "processedBy", "test-user-" + step
            )
        );
    }
     ...
     */
    public static Map<String, Object> customEvent(String eventType, Map<String, Object> customPayload) {
        return Map.of(
            "event", eventType,
            "payload", Map.of(
                "timestamp", java.time.Instant.now().toString(),
    ...
    public static Map<String, Object>[] eventBatch() {
        return new Map[]{
            completionEvent("user-1"),
            processEvent(1500.0),
            approvalEvent("agent-1", 1000.0),
     ...
     */
    public static Map<String, Object> contextualEvent(String eventType, Map<String, Object> context) {
