...
/**
 * Standardized error codes for the Journey Orchestrator application.
 * Each error code provides a unique identifier and default message for programmatic handling.
 */
