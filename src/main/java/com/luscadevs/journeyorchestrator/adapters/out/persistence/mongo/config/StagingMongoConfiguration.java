...
/**
 * MongoDB configuration for staging environment. Uses staging MongoDB instance with
 * staging-specific settings and connection pooling.
 */
@Configuration
@Profile("staging")
public class StagingMongoConfiguration {
    ...
    public StagingMongoConfiguration(MongoPersistenceProperties mongoProperties) {
