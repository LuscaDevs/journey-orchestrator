...
public class ProdMongoConfiguration {
        ...
        public ProdMongoConfiguration(MongoPersistenceProperties mongoProperties) {
                ...
                if (mongoProperties.getUri() != null) {
                        ...
                        MongoClientSettings.Builder settingsBuilder = MongoClientSettings.builder()
                                        ...
                                        .applyToConnectionPoolSettings(builder -> builder
                                                        ...
                                                        .maxWaitTime(mongoProperties
                                                                        .getConnectionTimeout(),
                                                                        TimeUnit.MILLISECONDS)
                                                        .maxConnectionIdleTime(30000,
                                                                        TimeUnit.MILLISECONDS)
                                                        .maxConnectionLifeTime(180000,
                                                                        TimeUnit.MILLISECONDS))
                                        .applyToSocketSettings(builder -> builder
                                                        .connectTimeout(mongoProperties
                                                                        .getConnectionTimeout(),
                                                                        TimeUnit.MILLISECONDS)
