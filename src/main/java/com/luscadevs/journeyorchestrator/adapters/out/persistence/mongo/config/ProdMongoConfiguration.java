...
/**
 * MongoDB configuration for production environment. Uses production MongoDB cluster with
 * production-specific settings, security, and connection pooling.
 */
@Configuration
@Profile("prod")
public class ProdMongoConfiguration {
        ...
        if (mongoProperties.getUri() != null) {
            ...
            MongoClientSettings.Builder settingsBuilder = MongoClientSettings.builder()
                    ...
                    .applyToConnectionPoolSettings(
                            builder -> builder.maxSize(mongoProperties.getMaxPoolSize())
                                    .minSize(mongoProperties.getMinPoolSize())
                                    .maxWaitTime(mongoProperties.getConnectionTimeout(),
                    ...
                    .applyToClusterSettings(builder -> builder.serverSelectionTimeout(30000,
                            TimeUnit.MILLISECONDS));
    ...
    public MongoTemplate mongoTemplate(MongoClient mongoClient) {
        String databaseName = mongoProperties.getDatabase() != null ? mongoProperties.getDatabase()
                : "journey_orchestrator_prod";

        if (databaseName.equals("journey_orchestrator_prod")) {
            throw new IllegalStateException(
                    "Production database name must be explicitly configured");
        }
